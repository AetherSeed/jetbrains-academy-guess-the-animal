...
public class LanguageRules extends ListResourceBundle {
    ...
    private static final Pattern IS_CORRECT_STATEMENT = Pattern.compile("it (can|has|is) .+");
    private static final Pattern POSITIVE_ANSWER = Pattern.compile(
    ...
    protected Object[][] getContents() {
        return new Object[][]{
                ...
                {"animalName", (UnaryOperator<String>) data ->
                ...
                {"negativeFact", (UnaryOperator<String>) data -> generateSentence(data, Map.of(
                        "it can (.*)", "It can't $1.",
